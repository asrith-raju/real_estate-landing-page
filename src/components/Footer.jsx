...
const Footer = () => {
        ...
        <div className='pt-10 px-4 md:px-20 lg:px-32 w-full bg-gray-900 overflow-hidden' id='Footer'>
            <div className='container mx-auto flex flex-col md:flex-row justify-between items-center'>
                <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                    ...
                    <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eos dolor eaque quibusdam explicabo asperiores beatae.</p>
                </div>
    ...
    text-white'>Subscribe</button>
            ...
            <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
                      Copyright 2025 © Asrith. All Right Reversed.
